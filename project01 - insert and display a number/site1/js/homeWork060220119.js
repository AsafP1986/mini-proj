...
function importImg() {
    ...
    document.getElementById("outputpara").innerHTML += "</br>";
...
function newCaruselleItem() {
    ...
    document.getElementById('carousel-inner').innerHTML += "<div id='img+" + countIMG + "' class='carousel-item'><img class='d-block w-100' src='" + imgURL + "'/></div>";
